...
export default {
  ...
  body: [
    ...
    ['example', {
      ...
      setup: R`A family in Hanoi plans to send 100,000,000 dong to their daughter in Sydney. When they first plan the transfer, one Australian dollar costs 18,000 dong. By the time they send it, the Australian dollar has strengthened to 18,500 dong. (These rates are illustrative; in late September 2026 one Australian dollar bought roughly 18,000 to 18,300 dong.)`,
      steps: [
        R`At 18,000 dong per dollar: \(100{,}000{,}000 / 18{,}000 = \$5{,}555.56\).`,
        R`At 18,500 dong per dollar: \(100{,}000{,}000 / 18{,}500 = \$5{,}405.41\).`,
        R`Difference: \(\$5{,}555.56 - \$5{,}405.41 = \$150.15\), about 2.7% less.`,
      ],
      answer: R`A 2.8% rise in the Australian dollar cost the family about $150. Exchange-rate risk runs both ways, and it can be managed by timing, by splitting transfers over several dates, or with the hedging tools you will study in the Financial System and Derivative Securities subjects. Remember also to compare transfer fees and the margin hidden in the exchange rate a provider quotes.`,
    }],
...
Her employer will pay superannuation into a fund for her, and she has heard that she can claim her super when she leaves Australia. She wants to build a small emergency fund and perhaps start investing in an ETF by the end of the year.`,
  ...
  exercises: [
    ...
    { type: 'num', level: 'Core', q: R`A family sends 150,000,000 dong when one Australian dollar costs 18,200 dong. How many Australian dollars arrive, before fees?`, answer: 8241.76, tol: 0.5, solution: R`150,000,000 / 18,200 = **$8,241.76**. Always divide the foreign amount by the price of one Australian dollar in that currency.` },
